...
A fully responsive frontend clone of the Spotify Web Player built with HTML5, CSS3
...
## 🔮 Future Improvements
* Add backend integration (Node.js/Express) to serve real audio data.
* Implement "Shuffle" and "Repeat" algorithms using Data Structures.
